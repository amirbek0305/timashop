...
const translations = {
  ...
  // Hero
  heroTitle: {
    uz: 'Zamonaviy uslubda kiyining',
    ru: 'Одевайтесь в современном стиле',
    en: 'Dress in Modern Style',
  },
  heroSubtitle: {
    uz: 'Erkaklar uchun sifatli va zamonaviy kiyimlar',
    ru: 'Качественная и современная мужская одежда',
    en: "Quality & Modern Men's Fashion",
  },
  ...
  sendToTelegram: {
    uz: 'Telegram orqali sotuvchiga yuborish',
    ru: 'Отправить продавцу через Telegram',
    en: 'Send to Seller via Telegram',
  },
  orderSuccess: {
